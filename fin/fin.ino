...
char blynk_token1[40] = "message here";//add field here<------------------------------------------------
 int  buttonPin = 0;
...
void setup() {
  ...
  WiFiManagerParameter custom_blynk_token("blynk", "mail to", blynk_token, 40);
...
byte sendEmail(int x) 
{
  ...
  Serial.println(F("--- Sending To")); client.println(blynk_token); if (!eRcv(client)) return 0;
